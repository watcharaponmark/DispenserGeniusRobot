...
import biz.markgo.dispensergeniusrobot.dispensergeniusrobot.MainActivity;
import biz.markgo.dispensergeniusrobot.dispensergeniusrobot.R;

public class PainkillerActivity extends AppCompatActivity {

    private String TAG = PainkillerActivity.class.getSimpleName();
...
//#####################################################################################
        ...
        Layout_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String Channel = "Servo1";
                String Value = "1";

                Log.e(TAG,"bt_drug1 : servo1-1");
