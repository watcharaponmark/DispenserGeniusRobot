...
public class DiarrheaActivity extends AppCompatActivity {

    private String TAG = DiarrheaActivity.class.getSimpleName();
...
//#####################################################################################
        ...
        Layout_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String Channel = "Servo4";
                String Value = "1";

                Log.e(TAG,"bt_drug2 : servo4-1");
