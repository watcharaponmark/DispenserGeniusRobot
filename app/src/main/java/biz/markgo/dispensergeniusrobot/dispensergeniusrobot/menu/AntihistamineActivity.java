...
public class AntihistamineActivity extends AppCompatActivity {

    private String TAG = AntihistamineActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_antihistamine);
...
//#####################################################################################
        ...
        Layout_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String Channel = "Servo2";
                String Value = "1";

                Log.e(TAG,"bt_drug2 : servo2-1");
